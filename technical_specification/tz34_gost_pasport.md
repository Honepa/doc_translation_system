...
1. работа с новыми даными в Cистеме;

1.1. загрузка отсканированного документа в интерфейсе Системы;

1.2. после загрузки документа отправить его на обработку подсистеме распознавания текстов;

1.3. после вывода пользователю результата распознавания, производство работ пользователем по обработке текста;

1.4. сохранение полученного документа в базе данных; 

2. работа с загруженными данными;

2.1. выбор документа из базы данных (поиск по индификационному номеру, ключевым словам и т.п);
2.2. изменение документа;
2.3. сохранение изменений;
2.4. выгрузка документа в формате "docx".
...
1.1. "Разработка модели пользователя приложения, механизма регистрации
пользователей, механизма входа-выхода из приложения (серверная часть)."

1.2. "Разработка интерфейса формы регистрации пользователей, и
входа-выхода из приложения (клиентская часть)."

1.3. Тестирование работы разработанного интерфейса.

1.4. Разработка модели данных совместно с описанием структуры форм для
заполнения.

1.5. Разработка модуля генерации ссылок на документы.

1.6. Разработка модуля поиска по критериям документов.

1.7. Обеспечение обмена данными с клиентом (прием, отправка и разбор
данных, серверная часть).

1.8. Тестирование полученной серверной части.

1.9. Выполнение тестирования взаимодействия компонентов системы.

1.10. Развертывание системы:

1.10.1. Настройка сервера приложений;

1.10.2. Настройка веб-сервера;

1.10.3. Настройка сервера СУБД;

1.10.4. Настройка DNS и доменных имён.

2. Техническое задание.
2.1. Написание технического задания.
2.2. Согласование технического задания с Заказчиком.
