...
1.1.1. Пользователю предлагется выбрать тип документа, выбрав его из предложенной системой таблицы, в таблице организован поиск и сохранения положения на, выбранной в прошлый раз, ячейке;
...
1.1.3. После оканчания работ по редактирования докуманта, пользователь сохраняет документ в базе и при необходимости выгружает получившийся шаблон в формате "docx" (можно вывести на печать);
...
1.2.2. пользователь проделывает операции п. 1.1.2 - 1.1.3.
