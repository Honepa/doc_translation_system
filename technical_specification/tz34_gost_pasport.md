...
2. Обзор текущих решений.

1.1. поиск готового решения распознавания текстов.
1.2. тестирование распознавания текстов на предоставленых Заказчикомчиком данных.
1.3. согласование с Заказчиком результатов тестирования распознавания документов.
